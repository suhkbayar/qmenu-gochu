...
const ListCardSkelton = () => {
  return (
    <>
      <div className="bg-gray-200 dark:bg-gray-700 p-4 rounded-lg h-72 w-full animate-pulse">
        ...
        <div className="h-4 bg-gray-200 dark:bg-gray-600 rounded-full w-3/4 mb-2"></div>
...
export default ListCardSkelton;
