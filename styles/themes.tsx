export const customThemeModal = {
  ...
  footer: {
    base: 'flex items-center place-content-around space-x-2 rounded-b border-gray-200 p-1 ',
    popup: 'border-t',
  },
};

export const customThemeModal1 = {
  root: {
    base: 'fixed top-0 right-0 left-0 z-50 h-full  overflow-y-auto overflow-x-hidden md:inset-0 md:h-full',
    show: {
      on: 'flex bg-gray-900 dark:bg-opacity-80',
      off: 'hidden',
    },
    sizes: {
      sm: 'max-w-sm',
  ...
  content: {
    ...
    inner:
      'relative overflow-auto md:rounded-lg  bg-white shadow flex flex-col h-full lg:h-3/5 justify-between lg:justify-start',
  },
  body: {
    base: 'flex-1 overflow-auto',
    popup: 'pt-0',
  ...
  header: {
    base: 'flex items-start justify-between    border-b p-5',
  ...
  footer: {
    base: 'flex items-center place-content-around space-x-2 rounded-b border-gray-200 p-0 ',
    popup: 'border-t',
  },
};
...
export const customAlertModal = {
  root: {
    base: 'fixed top-0 right-0 left-0 z-50 h-screen overflow-y-auto overflow-x-hidden inset-0 ',
    show: {
      on: 'flex bg-gray-900 bg-opacity-50 dark:bg-opacity-80',
      off: 'hidden',
    },
  ...
  footer: {
    base: 'flex items-center space-x-2 rounded-b border-gray-200 p-2 ',
    popup: 'border-t',
  },
};
...
export const customThemeWaiterModal = {
  root: {
    base: 'fixed top-0 right-0 left-0 z-50 h-modal h-screen overflow-y-auto overflow-x-hidden inset-0 ',
    show: {
      on: 'flex bg-gray-900 bg-opacity-50 dark:bg-opacity-80',
      off: 'hidden',
    },
...
export const customThemePaymentModal = {
  ...
  footer: {
    base: 'flex items-center space-x-2 rounded-b border-gray-50 p-2 ',
    popup: 'border-t',
  },
};
